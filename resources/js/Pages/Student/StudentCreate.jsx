                            ...
                            <div className="space-y-12">
                                ...
                                <div class="flex flex-wrap">
                                    <div class="w-full md:w-1/2 mb-6 md:mb-0 pr-2">
                                        ...
                                        <input
                                            class="appearance-none block w-full bg-white  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                            type="number"
                                            placeholder="087564195172"
                                            value={phone}
                                            onChange={(e) =>
                                    ...
                                    <div class="w-full md:w-1/2 pl-2">
                                        ...
                                        <input
                                            class="appearance-none block w-full bg-white rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                            id="address"
                                            type="text"
